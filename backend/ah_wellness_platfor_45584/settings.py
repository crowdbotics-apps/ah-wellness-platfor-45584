"""
Django settings for ah_wellness_platfor_45584 project.
...
ROOT_URLCONF = 'ah_wellness_platfor_45584.urls'
...
WSGI_APPLICATION = 'ah_wellness_platfor_45584.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ah_wellness_platfor_45584 API",
    "DESCRIPTION": "API documentation for ah_wellness_platfor_45584 App",
    "VERSION": "v1",
}
